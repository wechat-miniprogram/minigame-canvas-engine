...
`,-1);function m(_,p){const n=o("RouterLink");return r(),s("div",null,[d,e("p",null,[t("继承自 "),l(n,{to:"/components/element.html"},{default:i(()=>[t("Element")]),_:1}),t("。")]),h,u])}const w=a(c,[["render",m],["__file","view.html.vue"]]);export{w as default};
