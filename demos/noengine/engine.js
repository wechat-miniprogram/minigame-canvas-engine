        ...
        if (typeof Proxy === 'function') {
            ...
            this.style = new Proxy(this.originStyle, {
                ...
                set: function (target, prop, val, receiver) {
                    ...
                    if (typeof prop === 'string' && oldVal !== val) {
                        ...
                        if (prop === 'transform') {
                            ...
                            if (ele_1.children.length) {
                                ele_1.children[0].style.transform = val;
                            }
                ...
                deleteProperty: function (target, prop) {
                    var _a;
                    if (prop === 'transform') {
                        ele_1.renderForLayout = {};
                        if (ele_1.children.length) {
                            delete ele_1.children[0].style.transform;
                            ele_1.children[0].renderForLayout = {};
                        }
                        (_a = ele_1.root) === null || _a === void 0 ? void 0 : _a.emit('repaint');
                    }
