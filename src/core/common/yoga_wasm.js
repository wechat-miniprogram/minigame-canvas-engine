...
const Function = WXWebAssembly.Function
...
var Yoga = (function () {
    ...
    return function (Module) {
      ...
      function createWasm() {
        ...
        function instantiateArrayBuffer(receiver) {
          return WebAssembly.instantiate(wasmBinary, info).then(result => {
            console.log(2222, result, receiver)
            receiver(result)
          })
        }
      ...
      function createWasmSync() {
        ...
        function instantiateArrayBuffer() {
          ...
          // fs.mkdir('yoga')
          // const res = fs.writeFileSync('yoga.txt', wasmBinary)

          // console.log(res)

          // return receiveInstantiatedSource(new WebAssembly.Instance(
            // new WebAssembly.Module(bytes), info));
          ...
          return receiveInstantiatedSource(instance);
        }
  ...
  function init(opt) {
    ...
    if (opt.sync) {
      ...
      return Object.assign(mod, entryCommon(bind, syncMod));
    } else {
      return task;
    }
  }
