...
var Button = /** @class */ (function (_super) {
    ...
    function Button(_a) {
        ...
        _this.on('touchstart', function () {
            _this.style.transform = 'scale(1.05, 1.05)';
        });
        _this.on('touchend', function () {
            _this.style.transform = 'scale(1, 1)';
        });
        console.log(_this);
        return _this;
    }
