...
<span>    欢迎参加《空之旅人》命运测试，本次测试为安卓计费删档测试，测试时间为2021年1月26日~2021年2月2日，测试期间游戏内将开启充值功能。在本次命运测试期间，神位者大人在游戏内的充值总金额，将在游戏正式上线后按照「充值返还规则」进行返还。</span>
