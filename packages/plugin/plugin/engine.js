...
var Element = /** @class */ (function () {
    ...
    Element.prototype.baseRender = function () {
        ...
        var originY = 0;
        if (this.renderForLayout.rotate) {
            if ((_a = this.parent) === null || _a === void 0 ? void 0 : _a.renderForLayout.rotate) {
                // @ts-ignore
                originX = ((_b = this.parent) === null || _b === void 0 ? void 0 : _b.layoutBox.absoluteX) + ((_c = this.parent) === null || _c === void 0 ? void 0 : _c.layoutBox.width) / 2;
                // @ts-ignore
                originY = ((_d = this.parent) === null || _d === void 0 ? void 0 : _d.layoutBox.absoluteY) + ((_e = this.parent) === null || _e === void 0 ? void 0 : _e.layoutBox.height) / 2;
            }
            else {
                // @ts-ignore
        ...
        var _f = this.renderBorder(ctx, originX, originY), needClip = _f.needClip, needStroke = _f.needStroke;
        if (needClip) {
            ctx.clip();
        }
